    ...
    <>
      ...
      <section className="hero">
        <div className="container">
          ...
          <div
            className="dashboard-wrap reveal"
            style={{ display: "none" }}
          >
            <div className="float-stat left">
              <div className="num">94.2%</div>
              <div className="label">Inbox placement</div>
            </div>
            <div className="float-stat right">
              <div className="num">12.4%</div>
              ...
              <div className="dash-body">
                <div className="dash-sidebar">
                  <div className="dash-sidebar-item active">
                    <div className="icon"></div>Campaigns
                  </div>
                  <div className="dash-sidebar-item">
                    <div className="icon"></div>Inboxes
                  </div>
                  <div className="dash-sidebar-item">
                    <div className="icon"></div>Analytics
                  </div>
                  <div className="dash-sidebar-item">
                    <div className="icon"></div>Domains
                  </div>
                  <div className="dash-sidebar-item">
                    <div className="icon"></div>Settings
                  </div>
                </div>
                <div className="dash-main">
                  <div className="dash-header">
                    <h4>Active Campaigns</h4>
                    <div className="dash-search">Search campaigns...</div>
                  </div>
                  <div className="email-row">
                    ...
                    <div className="email-info">
                      <div className="email-name">James Donovan</div>
                      <div className="email-preview">
                        Re: Partnership opportunity, sounds great, let&apos;s
                        connect next week...
                      </div>
                    </div>
                    <span className="email-badge badge-replied">Replied</span>
                    <span className="email-time">2m ago</span>
                  </div>
                  <div className="email-row">
                    <div
                      className="avatar"
                      style={{
                        background:
                          "linear-gradient(135deg,#f97316,#e84393)",
                      }}
                    >
                      SK
                    </div>
                    <div className="email-info">
                      <div className="email-name">Sarah Kim</div>
                      <div className="email-preview">
                        Intro call follow up, thanks for taking the time to
                        chat...
                      </div>
                    </div>
                    <span className="email-badge badge-opened">
                      Opened 3x
                    </span>
                    <span className="email-time">18m ago</span>
                  </div>
                  <div className="email-row">
                    <div
                      className="avatar"
                      style={{
                        background:
                          "linear-gradient(135deg,#28c840,#a855f7)",
                      }}
                    >
                      MR
                    </div>
                    <div className="email-info">
                      <div className="email-name">Mike Reynolds</div>
                      <div className="email-preview">
                        Q4 outreach campaign, initial batch of 500 prospects
                        loaded...
                      </div>
                    </div>
                    <span className="email-badge badge-sent">Sent</span>
                    <span className="email-time">1h ago</span>
                  </div>
                  <div className="email-row">
                    <div
                      className="avatar"
                      style={{
                        background:
                          "linear-gradient(135deg,#e84393,#f97316)",
                      }}
                    >
                      AL
                    </div>
                    <div className="email-info">
                      <div className="email-name">Amy Lopez</div>
                      <div className="email-preview">
                        New lead magnet sequence, first touchpoint performing
                        well...
                      </div>
                    </div>
                    <span className="email-badge badge-opened">
                    ...
                    <span className="email-time">3h ago</span>
                  </div>
                  <div className="email-row">
                    <div
                      className="avatar"
                      style={{
                        background:
                          "linear-gradient(135deg,#a855f7,#28c840)",
                      }}
                    >
                      TC
                    </div>
                    <div className="email-info">
                      <div className="email-name">Tom Chen</div>
                      <div className="email-preview">
                        SaaS demo request, interested in enterprise plan
                        features...
                      </div>
                    </div>
                    <span className="email-badge badge-replied">Replied</span>
                    <span className="email-time">5h ago</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* ── 5. ABOUT ── */}
      <section className="about section-warm" style={{ padding: "80px 0" }}>
